...
(def special-forms (set ['var '. '.. 'if 'funcall 'fn 'quote 'set! 'return 'delete 'new 'do 'aget 'while 'doseq 'str 'inc! 'dec! 'dec 'inc 'ndefined? 'defined? 'and 'or '?]))
...
(defmethod emit-special 'ndefined? [type [_ var]]
  (str "typeof " (emit var) " == \"undefined\" && " (emit var) " == null"))
